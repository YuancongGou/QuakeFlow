...
if __name__ == '__main__':
    ...
    #pick_nres=3       # if pick's residual larger than nres times event's rms # the pick will not be used
    pick_nres=30
    ...
    maxdep_err=50 # in km, events with larger depth uncertainty will not be used
    maxdis_err=50 # in km, events with larger horizontal uncertainty will not be used
